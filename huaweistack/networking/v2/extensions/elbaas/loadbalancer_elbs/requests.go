...
func Create(c *huaweicloud.ServiceClient1, opts CreateOptsBuilder) (r CreateResult) {
	...
	_, r.Err = c.Post(rootURLh(c), b, &r.Body, &gophercloud.RequestOpts{
		OkCodes: []int{200},
	})
	return
}
...
func Get(c *huaweicloud.ServiceClient1, id string) (r GetResult) {
...
func Update(c *huaweicloud.ServiceClient1, id string, opts UpdateOpts) (r UpdateResult) {
...
func Delete(c *huaweicloud.ServiceClient1, id string) (r DeleteResult) {

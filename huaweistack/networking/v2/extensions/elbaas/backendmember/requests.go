...
func Add(c *huaweicloud.ServiceClient1, listener_id string, opts AddOptsBuilder) (r AddResult) {
...
func Remove(c *huaweicloud.ServiceClient1, listener_id string, id string) (r RemoveResult) {
	/*lbid := LoadBalancerID{
		ID: id,
	}
...
func Get(c *huaweicloud.ServiceClient1, listener_id, id string) (r GetResult) {
